...
export default function Experience() {
  const ExperienceProjects = [
    ...
    },
    {
      id: 3,
      image: heroImg,
      title: "Haptic Feedback Integration - Heseri Games",
      date: "October 2024",
      description: "During my co-op at Heseri Games, I integrated haptic feedback into a mobile game to enhance player immersion and tactile experience during gameplay events.",
      tags: ["Unity", "C#"],
      sections: [
        {
          images: [],
        ...
        {
          heading: "Haptic Feedback Integration",
        },
        {
          heading: "Project Summary",
          text: [
            "I researched, designed, and implemented a comprehensive haptic feedback system for a mobile game at Heseri Games, improving gameplay responsiveness and player engagement. The system provided tactile feedback during key gameplay events, such as collisions, power-ups, and environmental interactions, enhancing immersion and overall user experience. Using thoughtfully placed vibration cues created a more tactile and immersive experience, ultimately increasing user retention by 40% through A/B testing.",
          ],
        },
        {
          heading: "Problem Statement",
          text: [
            "The game originally offered no tactile or haptic feedback, making key interactions - such as plane launching, collisions, and upgrades - feel less impactful and less satisfying. The goal was to integrate haptics strategically to:",
            "▸ Enhance responsiveness of gameplay events and player immersion.",
            "▸ Provide sensory feedback for meaningful interactions.",
            "▸ Avoid overwhelming users with excessive vibrations.",
            "▸ Increase long-term engagement and retention.",
            "I needed to research haptic systems, choose a tool compatible with Unity and mobile platforms, and implement patterns across multiple gameplay events.",
          ],
        },
        {
          heading: "Role & Responsibilities",
          text: [
            "Position: Game Developer (Co-op)",
            "Responsibilities:",
            "▸ Researched haptics theory, vibration patterns, user experience implications, and Unity-compatible tools for mobile platforms.",
            "▸ Selected and integrated Nice Vibrations by MoreMountains into the project.",
            "▸ Designed and implemented a haptic feedback system that complemented key gameplay events without overwhelming users or becoming intrusive.",
            "▸ Implemented customizable patterns across key interactions, such as launch, collisions, achievements, UI interactions, etc.",
            "▸ Developed a settings toggle to enable or disable haptics for player control.",
            "▸ Coordinated A/B testing to measure impact on user engagement and retention, and measure performance.",
            "▸ Documented implementation guidelines for future interactive features.",
          ],
        },
        {
          heading: "Process Highlights",
          text: [
            ...
            "▸ Learned how haptics enhance cognitive feedback and immersion in mobile games.",
            "▸ Studied vibration categories: light taps, continuous rumble, medium impact, and celebratory patterns.",
            "▸ Evaluated Unity-compatible packages and haptics libraries and selected Nice Vibrations by MoreMountains for its flexibility, ease of use, and device support.",
            "Interaction Mapping & UX Planning:",
            "▸ Mapped out the full gameplay flow.",
            "▸ Identified interaction points where haptics would meaningfully reinforce player actions.",
            "▸ Avoided overuse and excessive feedback by prioritizing high-impact events and moments with high gameplay or emotional significance.",
            "Implementation:",
            "▸ Added haptics for...",
            "- Plane launch (initial ricochet)",
            "- Rocket activation",
            "- Plane collision",
            "- New distance records with confetti burst",
            "- Distance flag appearances",
            "- Level completion / cross finish line",
            "- Upgrade button interactions",
            "▸ Created a settings toggle to enable and disable haptics for player control.",
            "▸ Tuned intensity and duration for comfort and device compatibility.",
            "Testing & Iteration:",
            "▸ Conducted internal tests for comfort, timing precision, and consistency across devices.",
            "▸ Ran A/B tests with user groups to measure engagement, evaluate user retention, and gauge player satisfaction.",
          ],
        },
        {},
        {},
        {},
        {
          heading: "Outcome & Impact",
          text: [
            "▸ Successfully integrated a full haptic feedback system across gameplay and UI.",
            "▸ A/B testing demonstrated a 40% increase in user retention with haptics enabled, attributed to improved responsiveness and tactile engagement.",
            "▸ Enhanced perceived polish, interactivity, and user satisfaction.",
            "▸ Delivered a reusable and scalable haptics framework for future game features.",
            "▸ Provided UX documentation guiding when and how to add haptics responsibly.",
          ],
        },
        {
          heading: "Key Takeaways",
          text: [
            "This project strengthened my understanding of tactile UX design, Unity integration workflows, and data-driven decision-making. Creating balanced, intentional haptic feedback reinforced how subtle sensory cues can significantly improve user experience and engagement. It also highlighted the importance of user testing and iteration to refine interactive systems based on real-world feedback and performance metrics.",
          ],
        },
      ],
    },
